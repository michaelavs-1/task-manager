...
const CSV_URL =
  'https://docs.google.com/spreadsheets/d/e/2PACX-1vTbSGGOVXESrSzFqHyFXdGNbpW_s7O6AVR8JF8MLzSXsLpJ5XCv3syW038Vp0pIapEWfYJ35hDXH_GJ/pub?gid=1331259028&single=true&output=csv'
...
async function prepareExpenses() {
  ...
  for (let i = 0; i < rows.length; i++) {
    ...
    // Skip duplicate/header rows (can appear anywhere)
